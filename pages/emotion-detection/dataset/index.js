            ...
            <div className="row">
                ...
                <div className="col-sm-9">
                    <div style = {{textAlign:'center'}}>
                        <h1 className="heading" style={{textAlign:'center',background:'radial-gradient(circle at 10% 20%, rgb(255, 12, 253) 0%, rgb(255, 241, 0) 80%)',WebkitBackgroundClip: 'text', color: 'transparent',fontFamily:'Helvetica Neue',display:'inline'}}>Dataset Comparision</h1>         
                    </div>
                    <div className="container" style={{marginTop:'10px'}}>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <BarChart chartId="mychart1" data={[1000,1000,400,200,300,100]}/>
                                <PieChart chartId="mychart2" data={[1000,1000,400,200,300,100]}/>
                            </div>
                            <div className="col-lg-6">
                                <div style={{fontFamily:'Helvetica Neue',textAlign:'justify',fontSize:'20px'}}>
                                    <h3>DataSet-2</h3>
                                ...
                                <BarChart chartId="mychart3" data={[500,469,420,371,421,319]}/>
                                <PieChart chartId="mychart4" data={[500,469,420,371,421,319]}/>
                            </div>
                        </div>
                    </div>
                </div>
